function functionHandle = def_phib_4_spm_new(robotHandle)
...
% def_phib_4_spm_new returns a MatLab function handle to a set of regressors
...
%
% Syntax:  functionHandle = def_phib_4_spm_new(robotHandle)
%
% Inputs:
